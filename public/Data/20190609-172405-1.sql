...
CREATE TABLE `tp_cates_ad` (
  ...
  `catesAd_img` varchar(255) CHARACTER SET utf8 NOT NULL COMMENT '栏目广告图片路径',
  `catesAd_position` varchar(3) CHARACTER SET utf8 NOT NULL COMMENT '栏目广告图片位置，0.左大图，1.右上图，2.右下图',
...
CREATE TABLE `tp_cates_brands` (
  ...
  `cb_brands_id` varchar(100) CHARACTER SET utf8 NOT NULL COMMENT '关联的品牌id列表',
  `cb_proimg` varchar(60) CHARACTER SET utf8 NOT NULL COMMENT '推广图地址',
