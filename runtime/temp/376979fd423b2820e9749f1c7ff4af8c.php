...
<button type="button" tooltip="添加导航" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('nav/add'); ?>'"> <i class="fa fa-plus"></i> 添加导航
</button>
<button type="submit" tooltip="导航排序" class="btn btn-sm btn-azure btn-addon"> <i class="fa fa-plus"></i> 导航排序</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        ...
                        <tbody>
                                ...
                                <td align="center" style="width: 100px; text-align: center;">
                                    <input type="text" style="text-align: center;" name="nav_sort[<?php echo $nav['nav_id']; ?>]" placeholder="50" value="<?php echo $nav['nav_sort']; ?>" />
                                </td>                                
                                <td align="center">
