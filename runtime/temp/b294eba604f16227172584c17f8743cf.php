                    ...
                    <ul class="breadcrumb">
                        <li>
                            <a href="<?php echo url('Index/index'); ?>">系统</a>
                                            ...
                                            <li>
                            <a href="<?php echo url('cates_words/lst'); ?>">关联词汇管理</a>
                        </li>
                        <li class="active">添加关联词汇</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">添加关联词汇</span>
            </div>
                ...
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="cw_word" type="text">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="cw_linkurl" type="text">
                            </div>
