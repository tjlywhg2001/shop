                        ...
                        <div class="tab-content tabs-flat">
                            ...
                            <div class="tab-pane" id="comm_attrlist">
                                <div class="form-group">
                                    ...
                                    <div class="col-sm-6">
                                        <select name="type_id" <?php if($commedit['type_id'] != 0): ?> disabled="disabled" <?php endif; ?> >
                                            <option value="">请选择</option>
