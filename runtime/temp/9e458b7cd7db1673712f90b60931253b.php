<?php if (!defined('THINK_PATH')) exit(); /*a:3:{s:62:"B:\aaaweb\shop\public/../application/member\view\user\reg.html";i:1566090749;s:56:"B:\aaaweb\shop\application\member\view\common\_meta.html";i:1566098532;s:57:"B:\aaaweb\shop\application\member\view\common\footer.html";i:1566090749;}*/ ?>
<!doctype html>
<html>
                ...
                <div class="register-wrap">
                    ...
                    <div class="register-form">
                    	<div class="form form-other">
                            <form action="" method="post" name="formUser" onsubmit="return mobileRegister();">
                            	<div class="item">
                                	<div class="item-label">用　户　名</div>
                                	<div class="item-info">
                                    	<input type="text" name="us_name" id="username" onblur="is_registered(this.value, 1);" class="text" value="" autocomplete="off" />
                                    </div>
                                ...
                                <div class="item">
                                	...
                                	<div class="item-info">
                                    	...
                                    	<input type="password" name="us_password" id="pwd" class="text" value="" autocomplete="off" />
                                    </div>
                                ...
                                <div class="item">
                                	...
                                	<div class="item-info">
                                        <input type="password" style="display:none"/>
                                    	<input type="password" name="" id="pwdRepeat" class="text" value="" autocomplete="off" />
                                    </div>
                                ...
                                <div class="item" id="phone_yz">
                                	...
                                	<div class="item-info" style="position: relative;">
                                    	<input type="text" name="us_mobile_phone" id="mobile_phone" onblur="checkPhone(this.value);" class="text" value="" autocomplete="off" />
                                ...
                                <div class="item" id="email_yz" style="display:none;">
                                	<div class="item-label">电 子 邮 件</div>
                                	<div class="item-info" style="position: relative;">
                                    	<input type="text" name="us_email" id="regName" onblur="checkEmail(this.value);" class="text" value="" autocomplete="off" />
								...
								<div class="item" id="code_mobile">
	                                ...
	                                <div class="item-info">
	                                    <input type="text" name="" id="send_code" class="text text-2" value="" autocomplete="off">
								...
								<div class="item" id="code_email" style="display:none;">
                                	...
                                	<div class="item-checkbox">
                                        <input type="checkbox" id="clause2" class="ui-solid-checkbox" checked="checked" value="1" name="">
...
<!-- 									<input type="hidden" name="flag" id="flag" value='register' />
 ...
 -->									<input type="submit" id="registsubmit" name="" maxlength="8" class="btn sc-redBg-btn" value="立即注册"/>
                                </div>
                            </form>
                    	</div>            
                    </div>
