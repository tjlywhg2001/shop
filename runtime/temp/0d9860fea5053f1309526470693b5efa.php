    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">添加广告图片</span>
            </div>
                    ...
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6" style="padding: 6px 10px;">
                                <input class="" id="username" name="catesAd_img" type="file">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <div class="radio" style="display: inline-block; padding-right: 20px;">
                                    <label>
                                        <input class="inverted colored-blue" value="0" name="catesAd_position" type="radio" checked="checked">
                                        <span class="text">轮播大图</span>
                                    </label>
                                </div>
                                <div class="radio" style="display: inline-block; padding-right: 20px;">
                                    <label>
                                        <input class="inverted colored-blue" value="1" name="catesAd_position" type="radio">
                                        <span class="text">第一个图</span>
                                    </label>
                                </div>
                                <div class="radio" style="display: inline-block; padding-right: 20px;">
                                    <label>
                                        <input class="inverted colored-blue" value="2" name="catesAd_position" type="radio">
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="catesAd_url" type="text">
                            </div>
                            <p class="help-block col-sm-4 red">* 必填</p>
                        </div>
