...
<button type="button" tooltip="" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('Category/add'); ?>'"> <i class="fa fa-plus"></i> 添加分类
</button>
<button type="submit" tooltip="" class="btn btn-sm btn-azure btn-addon"> <i class="fa fa-plus"></i> 分类排序
</button>
<div class="row">
