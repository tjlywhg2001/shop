<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:63:"B:\aaaweb\shop\public/../application/admin\view\cates\list.html";i:1563666257;s:55:"B:\aaaweb\shop\application\admin\view\common\_meta.html";i:1563666257;s:53:"B:\aaaweb\shop\application\admin\view\common\top.html";i:1563666257;s:54:"B:\aaaweb\shop\application\admin\view\common\left.html";i:1563666257;s:56:"B:\aaaweb\shop\application\admin\view\common\footer.html";i:1563666257;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
            ...
            <div class="navbar-header pull-right">
                <div class="navbar-account">
                    <ul class="account-area">
                        <li class="dropdown-footer" style="margin: 0 10px; padding: 0 10px; line-height: 45px;">
                            <a href="<?php echo url('admin/index/cacher'); ?>" style=" color: #fff; ">
                                清空缓存
                            </a>
                        </li>
                        <li>
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr styl>
                                ...
                                <th class="text-center">商品分类关键词</th>
                                <th class="text-center">商品分类描述</th>
                                <th class="text-center">商品分类图标英文名</th>
                                <th class="text-center">商品分类颜色英文名</th>
                        ...
                        <?php if(is_array($cateslist) || $cateslist instanceof \think\Collection || $cateslist instanceof \think\Paginator): $i = 0; $__LIST__ = $cateslist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$cates): $mod = ($i % 2 );++$i;?>
                                <tr>
                                <td align="center" width="5%" data-type="<?php echo $cates['cates_pid']; ?>" class="datalist"><?php echo $cates['cates_id']; ?></td>
                                ...
                                <td align="center" width="10%" height="30"><?php echo $cates['cates_keywords']; ?></td>
                                <td align="center" width="10%" height="30"><?php echo $cates['cates_description']; ?></td>
                                <td align="center" width="10%" height="30"><?php echo $cates['cates_icon']; ?></td>
                                <td align="center" width="10%" height="30"><?php echo $cates['cates_color']; ?></td>
                                <td align="center" width="10%" height="30">
                                <?php if($cates['cates_img'] != ''): ?>
                                    <img style="height: 30px" src="/static/uploadss/<?php echo $cates['cates_img']; ?>" />
                                <?php else: ?>
                                    暂无图片
                                <?php endif; ?>
</td>
