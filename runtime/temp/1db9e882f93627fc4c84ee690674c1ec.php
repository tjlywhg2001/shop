                    ...
                    <ul class="breadcrumb">
                        <li>
                            <a href="<?php echo url('Index/index'); ?>">系统</a>
                                            ...
                                            <li>
                            <a href="<?php echo url('cates_words/lst'); ?>">链接管理</a>
                        </li>
