...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('CatesAd/add'); ?>'"> <i class="fa fa-plus"></i> 添加广告图片
</button>
<div class="row">
                    ...
                    <table class="table table-bordered table-hover">
                        <thead class="">
                            <tr styl>
                                ...
                                <th class="text-center">广告图片位置</th>
                                <th class="text-center">广告图片链接</th>
                                <th class="text-center">所属的栏目</th>
                                <th class="text-center">操作</th>
                            </tr>
                        </thead>
                        
                        <?php if(is_array($CatesAdList) || $CatesAdList instanceof \think\Collection || $CatesAdList instanceof \think\Paginator): $i = 0; $__LIST__ = $CatesAdList;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$CatesAd): $mod = ($i % 2 );++$i;?>
                        <tbody>
                                <tr>
                                <td align="center"><?php echo $CatesAd['catesAd_id']; ?></td>
                                <td align="center">
                                <?php if($CatesAd['catesAd_img'] != ''): ?>
                                    <img style="height: 30px" src="/static/uploadss/<?php echo $CatesAd['catesAd_img']; ?>" />
                                <?php else: ?>
                                    暂无图片
                                <?php endif; ?>
                                </td>
                                <td align="center">
                                <?php if($CatesAd['catesAd_position'] == 0): ?>
                                    轮播大图
                                <?php elseif($CatesAd['catesAd_position'] == 1): ?>
                                    第一个图
                                <?php elseif($CatesAd['catesAd_position'] == 2): ?>
                                    第二个图
                                <?php endif; ?>
                                </td>
                                <td align="center"><?php echo $CatesAd['catesAd_url']; ?></td>
                                <td align="center"><?php echo $CatesAd['cates_name']; ?></td>
                                <td align="center">
                                    <a href="<?php echo url('edit',array('catesAd_id'=>$CatesAd['catesAd_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('catesAdId'=>$CatesAd['catesAd_id'])); ?>')" class="btn btn-danger btn-sm shiny">
