...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('recpos/add'); ?>'"> <i class="fa fa-plus"></i> 添加商品属性
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($reclist) || $reclist instanceof \think\Collection || $reclist instanceof \think\Paginator): $i = 0; $__LIST__ = $reclist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$rec): $mod = ($i % 2 );++$i;?>
                        <tbody>
                                <tr>
                                <td align="center" width="5%"><?php echo $rec['rec_id']; ?></td>
                                <td align="+center" width="12%">
                                    <?php echo $rec['rec_name']; ?>
                                    
                                </td>
                                <td align="center" width="5%">
                                <?php if($rec['rec_type'] == 1): ?>
                                    商品
                                <?php else: ?>
                                    分类
                                <?php endif; ?>
                                ...
                                <td align="center" width="12%">
                                    <a href="<?php echo url('edit',array('rec_id'=>$rec['rec_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('rec_id'=>$rec['rec_id'])); ?>')" class="btn btn-danger btn-sm shiny">
