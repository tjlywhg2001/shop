...
<button type="button" tooltip="添加用户" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('recpos/add'); ?>'"> <i class="fa fa-plus"></i> 添加推荐位
</button>
<div class="row">
