                    ...
                    <ul class="breadcrumb">
                        <li>
                            <a href="<?php echo url('Index/index'); ?>">系统</a>
                                            ...
                                            <li>
                            <a href="<?php echo url('alternateImg/lst'); ?>">轮播图管理</a>
                        </li>
            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="alimg_id" value="<?php echo $alterEdit['alimg_id']; ?>">
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">轮播图标题</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="alimg_title" rtype="text" value="<?php echo $alterEdit['alimg_title']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="alimg_url" type="text" value="<?php echo $alterEdit['alimg_url']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">轮播图图片</label>
                            <div class="col-sm-6">
                                <input class="" id="username" name="alimg_src" type="file" value="<?php echo $alterEdit['alimg_src']; ?>">
                                <?php if($alterEdit['alimg_src'] != ''): ?>
                                    <img src="/static/uploadss/<?php echo $alterEdit['alimg_src']; ?>" style="height: 30px">
                                <?php else: ?>
                                    暂无图片
                                <?php endif; ?>
                            </div>
                       ...
                       <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">轮播图状态</label>
                            <div class="col-sm-6">
                                <div class="radio" style="float:left; padding-right: 10px;">
                                    <label>
                                        <input class="inverted colored-blue" value="1" name="alimg_status" type="radio" <?php if($alterEdit['alimg_status'] == 1): ?> checked="checked" <?php endif; ?>>
                                        <span class="text">显示</span>
                                    </label>
                                </div>
                                <div class="radio" style="float:left">
                                    <label>
                                        <input class="inverted colored-blue" value="0" name="alimg_status" type="radio" <?php if($alterEdit['alimg_status'] == 0): ?> checked="checked" <?php endif; ?>>
