                    ...
                    <ul class="breadcrumb">
                        <li>
                            <a href="<?php echo url('Index/index'); ?>">系统</a>
                                            ...
                                            <li>
                            <a href="<?php echo url('recpos/lst'); ?>">商品属性管理</a>
                        </li>
