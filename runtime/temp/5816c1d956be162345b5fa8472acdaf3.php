<?php if (!defined('THINK_PATH')) exit(); /*a:5:{s:71:"B:\aaaweb\shop\public/../application/admin\view\alternate_img\list.html";i:1563074804;s:55:"B:\aaaweb\shop\application\admin\view\common\_meta.html";i:1563066837;s:53:"B:\aaaweb\shop\application\admin\view\common\top.html";i:1563066837;s:54:"B:\aaaweb\shop\application\admin\view\common\left.html";i:1563071498;s:56:"B:\aaaweb\shop\application\admin\view\common\footer.html";i:1563066837;}*/ ?>
<!DOCTYPE html>
<html>
<head>
	    <meta charset="utf-8">
    ...
    <!-- My custom -->
    <script src="/static/admin/style/listShowHide.js"></script>
...
<button type="button" tooltip="" class="btn btn-sm btn-azure btn-addon" onClick="javascript:window.location.href = '<?php echo url('alternateImg/add'); ?>'"> <i class="fa fa-plus"></i> 添加轮播图
<button type="submit" tooltip="" class="btn btn-sm btn-azure btn-addon" style="margin-left: 5px;"> <i class="fa fa-plus"></i> 轮播图排序
</button>
</button>
<div class="row">
            ...
            <div class="widget-body">
                <div class="flip-scroll">
                    <table class="table table-bordered table-hover">
                        ...
                        <?php if(is_array($alterlist) || $alterlist instanceof \think\Collection || $alterlist instanceof \think\Paginator): $i = 0; $__LIST__ = $alterlist;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$alter): $mod = ($i % 2 );++$i;?>
                        <tbody>
                                <tr>
                                <td align="center"><?php echo $alter['alimg_id']; ?></td>
                                <td align="center"><?php echo $alter['alimg_title']; ?></td>
                                <td align="center"><?php echo $alter['alimg_url']; ?></td>
                                <td align="center">
                                <?php if($alter['alimg_src'] != ''): ?>
                                    <img style="height: 30px" src="/static/uploadss/<?php echo $alter['alimg_src']; ?>" />
                                <?php else: ?>
                                    暂无图片
                                <?php endif; ?>
                                </td>
                                ...
                                <td align="center">
                                    <input type="text" name="alimg_sort[<?php echo $alter['alimg_id']; ?>]" value="<?php echo $alter['alimg_sort']; ?>" style="width: 30px; text-align: center;" />
                                </td>
                                <td align="center">
                                    <a href="<?php echo url('edit',array('alimg_id'=>$alter['alimg_id'])); ?>" class="btn btn-primary btn-sm shiny">
                                        <i class="fa fa-edit"></i> 编辑
                                    </a>
                                    <a href="#" onClick="warning('确实要删除吗', '<?php echo url('del',array('alimg_id'=>$alter['alimg_id'])); ?>')" class="btn btn-danger btn-sm shiny">
