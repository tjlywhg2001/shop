            ...
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">商品分类图标英文名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="cates_icon" value="<?php echo $catess['cates_icon']; ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red"></p>
                        </div>
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">商品分类颜色英文名</label>
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="cates_color" value="<?php echo $catess['cates_color']; ?>" type="text">
                            </div>
                            <p class="help-block col-sm-4 red"></p>
                        </div>
