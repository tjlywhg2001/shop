<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:64:"B:\aaaweb\shop\public/../application/index\view\index\index.html";i:1563666257;s:55:"B:\aaaweb\shop\application\index\view\common\_meta.html";i:1563666257;s:59:"B:\aaaweb\shop\application\index\view\common\heads_top.html";i:1563666257;s:60:"B:\aaaweb\shop\application\index\view\common\heads_logo.html";i:1563666257;s:60:"B:\aaaweb\shop\application\index\view\common\heads_navs.html";i:1563666257;s:59:"B:\aaaweb\shop\application\index\view\common\title_top.html";i:1563666257;s:55:"B:\aaaweb\shop\application\index\view\common\right.html";i:1563666257;s:56:"B:\aaaweb\shop\application\index\view\common\footer.html";i:1563666257;s:63:"B:\aaaweb\shop\application\index\view\common\footer_script.html";i:1563666257;}*/ ?>
<!DOCTYPE html>
<html>
		    	...
		    	<div class="categorys-items" id="cata-nav">
		            ...
		            <div class="categorys-item" ectype="cateItem" data-id="<?php echo $CommCates['cates_id']; ?>" data-eveval="0">
				        <div class="item item-content">
						    <i class="iconfont <?php echo $CommCates['cates_icon']; ?>"></i>
						    <div class="categorys-title">
				                <strong>
    ...
    <div class="banner home-banner">
    	<div class="bd">
        	<ul data-type="range" data-slide="fold" style="position: relative; width: 1903px; height: 500px;">
                <?php if(is_array($IndexAlternateImg) || $IndexAlternateImg instanceof \think\Collection || $IndexAlternateImg instanceof \think\Paginator): $i = 0; $__LIST__ = $IndexAlternateImg;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$newAltrenateImg): $mod = ($i % 2 );++$i;?>
                <li style="background-image: url(&quot;/static/uploadss/<?php echo $newAltrenateImg['alimg_src']; ?>&quot;); background-position: center center; background-repeat: no-repeat; position: absolute; width: 1903px; left: 0px; top: 0px; display: none;"><div class="banner-width"><a href="<?php echo $newAltrenateImg['alimg_url']; ?>" target="_blank" style="height:500px;"></a></div></li>
                <?php endforeach; endif; else: echo "" ;endif; ?>
                                                ...
                                                <div class="vip-con">
                                                    <div class="insertVipEdit" data-mode="insertVipEdit">
                                                        <div ectype="user_info">
                                                            <div class="avatar">
                                                                <a href="user.php?act=profile"><img src="/static/index/img/avatar.png"></a>
                                                            </div>
        ...
        <div class="visual-item w1200" data-mode="homeFloor" data-purebox="homeFloor" data-li="1" ectype="visualItme" data-diff="0" style="display: block;">
            <div class="view">
                <div class="floor-content" data-type="range" id="homeFloor_0" data-lift="女装">
                    ...
                    <div class="floor-line-con floorOne floor-color-type-<?php echo $CatesRecpos['cates_color']; ?>" data-title="男装女装" data-idx="1" id="floor_<?php echo $CatesRecpos['cates_color']; ?>" ectype="floorItem">
                        ...
                        <!-- ==========================  广告轮播图 start ========================== -->
                        <?php if($CatesRecpos['cates_color'] == 4): ?>
                        ...
                        <?php elseif($CatesRecpos['cates_color'] == 1): ?>
                        ...
                        <?php elseif($CatesRecpos['cates_color'] == 2): ?>
...
<!--  -->
                        ...
                        <div class="floor-fd">
                            <div class="floor-fd-brand clearfix">
                                <?php foreach ( $CatesRecpos['newBrand']['children'] as $k => $v):
                                    ?>
                                    <div class="item">
                                        <a href="<?php echo $v['brand_url']; ?>" target="_blank">
                                            <div class="link-l"></div>
                                            <div class="img"><img src="/static/uploadss/<?php echo $v['brand_img']; ?>" title="<?php echo $v['brand_name']; ?>"></div>
                                            <div class="link"></div>
                                        </a>
                                    </div>
                                <?php endforeach;?>
...
<div class="spec" data-spec="" data-title="店铺"></div></div>
    ...
    <?php if(is_array($CommRecpos) || $CommRecpos instanceof \think\Collection || $CommRecpos instanceof \think\Paginator): $i = 0; $__LIST__ = $CommRecpos;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$CommRecpos): $mod = ($i % 2 );++$i;?>
    <li class="opacity_img">
        <a href="<?php echo url('index/goods/index',array('commodity_id'=>$CommRecpos['commodity_id'])); ?>" target="_blank">
            <div class="p-img"><img src="/static/uploadss/<?php echo $CommRecpos['commodity_ogthumb']; ?>"></div>
            <div class="p-name" title="<?php echo $CommRecpos['commodity_name']; ?>"><?php echo $CommRecpos['commodity_name']; ?></div>
            <div class="p-price">
                <div class="shop-price">
                    <em>¥</em><?php echo $CommRecpos['commodity_shop_price']; ?>
                </div>
                <div class="original-price"><em>¥</em><?php echo $CommRecpos['commodity_market_price']; ?></div>
            </div>
        </a>
    </li>
    <?php endforeach; endif; else: echo "" ;endif; ?>
...
function LoginArti() {
   ...
   <script type="text/javascript" src="/static/index/js/jquery_003.js"></script>
    ...
    <script type="text/javascript">
        ...
        var ttt = new Date();
        var div = '<div style="height: 100px; background: red; width: 100%;  color: #fff;">' + ttt + '</div>';
        $('body').append(div);
