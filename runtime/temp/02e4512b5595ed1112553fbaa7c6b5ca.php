            ...
            <ul>
                <li class="first">
                    ...
                    <i class="arrowImg"></i>
                                                                ...
                                                                <li data-catgoods="" class="first current" ectype="floor_cat_content" data-flooreveval="0" data-visualhome="1" data-floornum="6" data-id="463">
                    <span>男装</span>
                    <i class="arrowImg"></i>
                </li>
                                                            </ul>
