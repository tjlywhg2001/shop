<?php if (!defined('THINK_PATH')) exit(); /*a:9:{s:64:"B:\aaaweb\shop\public/../application/index\view\index\index.html";i:1562462351;s:55:"B:\aaaweb\shop\application\index\view\common\_meta.html";i:1562460434;s:59:"B:\aaaweb\shop\application\index\view\common\heads_top.html";i:1562460434;s:60:"B:\aaaweb\shop\application\index\view\common\heads_logo.html";i:1562460434;s:60:"B:\aaaweb\shop\application\index\view\common\heads_navs.html";i:1562460434;s:59:"B:\aaaweb\shop\application\index\view\common\title_top.html";i:1562460434;s:55:"B:\aaaweb\shop\application\index\view\common\right.html";i:1562460434;s:56:"B:\aaaweb\shop\application\index\view\common\footer.html";i:1562462378;s:63:"B:\aaaweb\shop\application\index\view\common\footer_script.html";i:1562460434;}*/ ?>
<!DOCTYPE html>
<html>
                                                ...
                                                <div class="vip-con">
                                                    <div class="insertVipEdit" data-mode="insertVipEdit">
                                                        ...
                                                        <div class="vip-item viptitle">
                                                            ...
                                                            <div class="con">
                                                                <ul>
                                                                        <?php if(is_array($loginList1) || $loginList1 instanceof \think\Collection || $loginList1 instanceof \think\Paginator): $i = 0; $__LIST__ = $loginList1;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$loginList1): $mod = ($i % 2 );++$i;?>
                                                                        <li><a href="<?php echo url('index/article/index',array('ar_id'=>$loginList1['ar_id'])); ?>" target="_blank"><?php echo $loginList1['ar_title']; ?></a></li>
                                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                                    </ul>
                                                                <ul style="display:none;">
                                                                        <?php if(is_array($loginList2) || $loginList2 instanceof \think\Collection || $loginList2 instanceof \think\Paginator): $i = 0; $__LIST__ = $loginList2;if( count($__LIST__)==0 ) : echo "" ;else: foreach($__LIST__ as $key=>$loginList2): $mod = ($i % 2 );++$i;?>
                                                                        <li><a href="<?php echo url('index/article/index',array('ar_id'=>$loginList2['ar_id'])); ?>" target="_blank"><?php echo $loginList2['ar_title']; ?></a></li>
                                                                        <?php endforeach; endif; else: echo "" ;endif; ?>
                                                                    </ul>
                                                                </div>
                                                            </div>
...
$(function () {
	...
	$('.viptitle').children('.con').before('<div class="tit"><a href="javascript:void(0);" class="tab_head_item">公告</a><a href="javascript:void(0);" class="tab_head_item">促销</a></div>');
