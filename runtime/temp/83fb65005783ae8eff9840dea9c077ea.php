                    ...
                    <ul class="breadcrumb">
                        <li>
                            <a href="<?php echo url('Index/index'); ?>">系统</a>
                                            ...
                                            <li>
                            <a href="<?php echo url('catesAd/lst'); ?>">广告图片管理</a>
                        </li>
                        <li class="active">修改广告图片</li>
                    </ul>
                </div>
                <!-- /Page Breadcrumb -->
    ...
    <div class="col-lg-12 col-sm-12 col-xs-12">
        <div class="widget">
            <div class="widget-header bordered-bottom bordered-blue">
                <span class="widget-caption">修改广告图片</span>
            </div>
            <div class="widget-body">
                <div id="horizontal-form">
                    <form class="form-horizontal" role="form" action="" method="post" enctype="multipart/form-data">
                        <input type="hidden" name="catesAd_id" value="<?php echo $catesAds['catesAd_id']; ?>">


                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">添加图片</label>
                            <div class="col-sm-6">
                                <input class="" id="username" name="catesAd_img" type="file" value="<?php echo $catesAds['catesAd_img']; ?>">
                                <?php if($catesAds['catesAd_img'] != ''): ?>
                                    <img src="/static/uploadss/<?php echo $catesAds['catesAd_img']; ?>" style="height: 30px">
                                <?php else: ?>
                                    暂无图片
                                <?php endif; ?>
                            </div>
                        ...
                        <div class="form-group">
                            <label for="username" class="col-sm-2 control-label no-padding-right">广告图片位置</label>
                            <div class="col-sm-6">
                                <div class="radio" style="display: inline-block; padding-right: 20px;">
                                    <label>
                                        <input class="inverted colored-blue" value="0" name="catesAd_position" type="radio" <?php if($catesAds['catesAd_position'] == 0): ?> checked="checked" <?php endif; ?>>
                                        <span class="text">轮播大图</span>
                                    </label>
                                </div>
                                <div class="radio" style="display: inline-block; padding-right: 20px;">
                                    <label>
                                        <input class="inverted colored-blue" value="1" name="catesAd_position" type="radio" <?php if($catesAds['catesAd_position'] == 1): ?> checked="checked" <?php endif; ?>>
                                        <span class="text">第一个图</span>
                                    </label>
                                </div>
                                <div class="radio" style="display: inline-block; padding-right: 20px;">
                                    <label>
                                        <input class="inverted colored-blue" value="2" name="catesAd_position" type="radio" <?php if($catesAds['catesAd_position'] == 2): ?> checked="checked" <?php endif; ?>>
                                        <span class="text">第二个图</span>
                                    </label>
                                </div>
                            </div>
                        </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <input class="form-control" id="username" placeholder="" name="catesAd_url" type="text" value="<?php echo $catesAds['catesAd_url']; ?>">
                            </div>
                        ...
                        <div class="form-group">
                            ...
                            <div class="col-sm-6">
                                <select name="catesAd_catesId">
                                    ...
                                    <option value="<?php echo $cates['cates_id']; ?>" <?php if($catesAds['catesAd_catesId'] == $cates['cates_id']): ?> selected="selected" <?php endif; ?>>
