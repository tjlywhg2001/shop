/*
 ...
 Source Schema         : tested

 Target Server Type    : MySQL
 Target Server Version : 50713
 File Encoding         : 65001

 Date: 08/06/2019 21:37:08
*/
...
CREATE TABLE `tp_article`  (
  ...
  `ar_title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '标题',
  `ar_keywords` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '关键词',
  `ar_description` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '描述',
  `ar_autor` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '作者',
  `ar_email` varchar(20) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '电子邮箱',
  `ar_linkurl` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '友情链接',
  `ar_thumbnail` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '缩略图',
  `ar_content` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '内容',
...
CREATE TABLE `tp_attr`  (
  ...
  `attr_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品属性名称',
  `attr_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品属性类型',
  `attr_values` varchar(500) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品属性值',
...
CREATE TABLE `tp_brand`  (
  ...
  `brand_name` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `brand_url` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `brand_img` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `brand_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `tp_category`  (
  ...
  `cate_keywords` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '关键词',
  `cate_description` varchar(150) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '描述',
...
CREATE TABLE `tp_cates`  (
  ...
  `cates_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品分类',
  `cates_keywords` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cates_description` varchar(200) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `cates_img` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品图片',
  ...
  PRIMARY KEY (`cates_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 530 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_cates_brands`  (
  ...
  `cb_brands_id` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '关联的品牌id列表',
  `cb_proimg` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '推广图地址',
  `cb_prourl` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '推广图链接',
...
CREATE TABLE `tp_cates_words`  (
  ...
  `cw_word` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '词汇',
  `cw_linkurl` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '链接地址',
  PRIMARY KEY (`cw_id`) USING BTREE,
  INDEX `cw_cates_id`(`cw_cates_id`) USING BTREE
) ENGINE = MyISAM AUTO_INCREMENT = 334 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Dynamic;
...
CREATE TABLE `tp_comm_attr`  (
  ...
  `commattr_value` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '属性值',
  `commattr_attrprice` decimal(10, 2) NOT NULL COMMENT '属性价格',
  `commattr_commid` mediumint(9) NOT NULL COMMENT '所属商品',
  PRIMARY KEY (`commattr_id`) USING BTREE
...
CREATE TABLE `tp_comm_photo`  (
  ...
  `comm_photo_og` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
  `comm_photo_sm` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '小图',
  `comm_photo_mid` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '中图',
  `comm_photo_big` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '大图',
  PRIMARY KEY (`comm_photo_id`) USING BTREE,
  INDEX `comm_commodity_id`(`comm_commodity_id`) USING BTREE
...
CREATE TABLE `tp_commodity`  (
  ...
  `commodity_name` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品名称',
  `commodity_code` char(16) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品编号',
  `commodity_ogthumb` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '原图',
  `commodity_smthumb` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '小缩略图',
  `commodity_midthumb` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '中缩略图',
  `commodity_bigthumb` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '大缩略图',
  ...
  `commodity_description` longtext CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '描述',
  `commodity_weight` decimal(10, 2) NOT NULL COMMENT '重量',
  `commodity_weight_unit` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'kg' COMMENT '单位',
  PRIMARY KEY (`commodity_id`) USING BTREE,
  INDEX `brand_id`(`brand_id`) USING BTREE,
  INDEX `cates_id`(`cates_id`) USING BTREE,
...
INSERT INTO `tp_commodity` VALUES (2, '康佳电风扇塔扇家用塔式落地扇静音无叶风扇定时扇遥控立式大厦扇 换季活动 晒图奖励30元 到手119元', 'ECS000847', '20190511/_P_1490209654592.jpg', '', '20190511/_thumb_P_1490209654387.jpg', '', 101.10, 86.22, 1, 9, 0, 26, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES (6, '顺鼎电动按摩椅家用全自动全身按摩垫智能颈椎按摩器老人椅子沙发', 'ECS000856', '20190511/0_P_1490209956657.jpg', '', '20190511/0_thumb_P_1490209956687.jpg', '', 105.10, 90.22, 1, 23, 0, 28, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (7, '都市丽人一片式无痕文胸厚杯性感聚拢舒适光面胸罩纯色商场同款 2016新品明星同款舒适Q软托无痕体验', 'ECS000795', '20190511/0_P_1490174703551.jpg', '', '20190511/0_thumb_P_1490174703212.jpg', '', 106.10, 91.22, 1, 63, 0, 68, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES
'', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (99, '宝石蝶真丝围巾女士春秋季高档丝巾重磅桑蚕丝大方巾披肩丝绸礼品 16姆米重磅真丝丝滑缎面90方巾礼盒包', 'ECS000781', '20190511/0_P_1490173699715.jpg', '', '20190511/0_thumb_P_1490173699210.jpg', '', 198.10, 183.22, 1, 62, 0, 67, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (100, '6林志玲花样姐姐同款海伦凯勒太阳镜女 偏光蛤蟆镜潮墨镜H8535 花样姐姐同款 林志玲设计 炫彩镂空', 'ECS000782', '20190511/_P_1490173863814.jpg', '', '20190511/_thumb_P_1490173863123.jpg', '', 199.10, 184.22, 1, 62, 0, 67, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES (111, 'Donlim/东菱 DL-KF500S 咖啡机家用全半自动意式商用蒸汽式打奶泡 不锈钢机身 20帕进', 'ECS000805', '20190511/0_P_1490175311789.jpg', '', '20190511/0_thumb_P_1490175311366.jpg', '', 210.10, 195.22, 1, 22, 0, 118, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (112, 'Midea/美的 TLC2000面包机家用全自动智能多功能不锈钢机身触摸屏 逼格好物 钢化上盖 时尚', 'ECS000806', '20190511/0_P_1490175339128.jpg', '', '20190511/0_thumb_P_1490175339297.jpg', '', 211.10, 196.22, 1, 22, 0, 117, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (113, 'TOSOT/大松 GDF-2001C格力电饭煲迷你智能全自动家用 电饭锅1-2人 格力出品 数码显示', 'ECS000848', '20190511/_P_1490209692088.jpg', '', '20190511/_thumb_P_1490209692646.jpg', '', 212.10, 197.22, 1, 22, 0, 27, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (114, '美的智能家用多功能双胆电压力锅高压锅饭煲正品WCS5025 5L小家电 5L双胆 智能预约 大面板', 'ECS000849', '20190511/_P_1490209723971.jpg', '', '20190511/_thumb_P_1490209723636.jpg', '', 213.10, 198.22, 1, 22, 0, 27, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES (116, '红叶伞遮阳伞防紫外线黑胶防晒晴雨两用太阳伞女糖果色折叠雨伞大 黑胶防晒 晴雨两用 糖果色 都市风情', 'ECS000783', '20190511/0_P_1490173894462.jpg', '', '20190511/0_thumb_P_1490173894937.jpg', '', 215.10, 200.22, 1, 62, 0, 67, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (117, 'RW/容威 GL-166迷你电饭锅2人-3人家用宿舍小型1-2-3人正品电饭煲 智能预约 1.8L容', 'ECS000850', '20190511/_P_1490209756075.jpg', '', '20190511/_thumb_P_1490209756656.jpg', '', 216.10, 201.22, 1, 22, 0, 27, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES (124, '美国iRobot529经典组合扫地机器人家用全自动智能擦地机国行热卖 告别手动 每日净尘 咨询送配件', 'ECS000824', '20190511/_P_1490204961251.jpg', '', '20190511/_thumb_P_1490204961313.jpg', '', 223.10, 208.22, 1, 9, 0, 105, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (125, '申花饮水机立式冷热办公室冰温热水机家用玻璃节能制冷开水机 32年老品牌 多仓速发 晒单奖20元', 'ECS000825', '20190511/_P_1490205002913.jpg', '', '20190511/_thumb_P_1490205002108.jpg', '', 224.10, 209.22, 1, 9, 0, 109, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (126, '美的壁扇FW40-F3挂壁式工业电风扇 家用台式餐厅摇头墙16寸电扇 热销壁扇 团购优选 3档风速', 'ECS000844', '20190511/_P_1490209562656.jpg', '', '20190511/_thumb_P_1490209562894.jpg', '', 225.10, 210.22, 1, 9, 0, 26, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES (128, '碧利沙电风扇家用落地扇宿舍台扇静音摇头小台式电扇立式学生风扇', 'ECS000845', '20190511/0_P_1490209587333.jpg', '', '20190511/0_thumb_P_1490209587331.jpg', '', 227.10, 212.22, 1, 9, 0, 26, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (129, '凉师傅无叶风扇静音落地扇家用立式遥控电风扇办公室循环扇客厅6A 凉师傅 无叶风扇 两年保修', 'ECS000846', '20190511/_P_1490209617748.jpg', '', '20190511/_thumb_P_1490209617740.jpg', '', 228.10, 213.22, 1, 9, 0, 26, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES (132, '马克华菲短袖T恤 夏装新款舒适圆领条纹拼接男简约修身短袖上衣', 'ECS000866', '20190511/0_P_1490211843690.jpg', '', '20190511/0_thumb_P_1490211843028.jpg', '', 231.10, 216.22, 1, 17, 0, 66, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (133, '森马夹克 2016冬装新款男士飞行夹克贴布绣立领休闲外套韩版潮流', 'ECS000785', '20190511/_P_1490174212677.jpg', '', '20190511/_thumb_P_1490174212863.jpg', '', 232.10, 217.22, 1, 17, 0, 66, '', 0.00, 'g');
...
INSERT INTO `tp_commodity` VALUES (135, 'YOHO有货潮牌LAL/数字贴布连帽套头卫衣男女通用 吴亦凡亲着同款 春夏焕新季，3.21日00:0', 'ECS000787', '20190511/_P_1490174307606.jpg', '', '20190511/_thumb_P_1490174307249.jpg', '', 234.10, 219.22, 1, 17, 0, 66, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (136, '裤子男士哈伦裤春季新款2017束脚裤修身韩版潮流小脚裤男裤休闲裤 弹力', 'ECS000786', '20190511/_P_1490174245373.jpg', '', '20190511/_thumb_P_1490174245021.jpg', '', 235.10, 220.22, 1, 17, 0, 346, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (137, 'HLA/海澜之家休闲西服2017春季新品平驳领时尚西装男单西外套 平驳领型 胸针装饰 青春休闲 舒适', 'ECS000788', '20190511/_P_1490174348733.jpg', '', '20190511/_thumb_P_1490174348731.jpg', '', 236.10, 221.22, 1, 17, 0, 66, '', 0.00, 'g');
INSERT INTO `tp_commodity` VALUES (138, '森马针织衫 冬季男圆领套头青年毛衣小清新线衫毛衫纯色韩版学生', 'ECS000789', '20190511/_P_1490174418377.jpg', '', '20190511/_thumb_P_1490174418305.jpg', '', 237.10, 222.22, 1, 17, 0, 66, '', 0.00, 'g');
...
CREATE TABLE `tp_config`  (
  ...
  `config_ename` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '英文名称',
  `config_cname` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '中文名称',
  `config_formtype` varchar(10) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT 'input' COMMENT '表单类型',
  `config_type` tinyint(1) NOT NULL DEFAULT 1 COMMENT '配置类型 1店铺配置 2商品配置',
  `config_values` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '可选值',
  `config_default` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '默认值',
...
CREATE TABLE `tp_links`  (
  ...
  `links_title` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '链接标题',
  `links_url` varchar(60) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '链接url',
  `links_logo` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '链接logo',
  `links_description` varchar(255) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL DEFAULT '' COMMENT '链接描述',
...
) ENGINE = MyISAM AUTO_INCREMENT = 191 CHARACTER SET = utf8 COLLATE = utf8_general_ci ROW_FORMAT = Fixed;
...
CREATE TABLE `tp_nav`  (
  ...
  `nav_name` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '导航名称',
  `nav_url` varchar(30) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '导航地址',
  `nav_open` tinyint(1) NOT NULL COMMENT '打开新页面 1.是 0.否',
  `nav_pos` varchar(6) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '导航位置：top:顶部 mid:中间 bottom:底部',
  `nav_sort` varchar(50) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL,
...
CREATE TABLE `tp_product`  (
  ...
  `product_commodity_attr_type` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品attr属性的类型',
...
CREATE TABLE `tp_recpos`  (
  ...
  `rec_name` mediumtext CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci NOT NULL COMMENT '推荐位名称',
...
INSERT INTO `tp_recpos_comm` VALUES (3, 35, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 36, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 37, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 38, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 40, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 41, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 42, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 43, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 45, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 46, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 47, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 48, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 52, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 72, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 73, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 74, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 83, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 84, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 85, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 86, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 95, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 97, 1);
...
INSERT INTO `tp_recpos_comm` VALUES (3, 114, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 116, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 117, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 124, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 125, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 126, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 128, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 129, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 132, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 133, 1);
INSERT INTO `tp_recpos_comm` VALUES (3, 135, 1);
...
CREATE TABLE `tp_type`  (
  ...
  `type_name` varchar(100) CHARACTER SET utf8 COLLATE utf8_general_ci NOT NULL COMMENT '商品类型名称',
